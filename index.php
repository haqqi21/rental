...
<head>
    ...
    <style>
        ...
        body {
            background-color:rgb(13, 37, 61);
        }
        .product-card .btn-primary {
    background-color:rgb(8, 36, 65); /* Warna biru */
    border: none;
    padding: 10px 20px;
    border-radius: 5px;
...
.product-card .btn-primary:hover {
    background-color:rgb(7, 7, 8); /* Warna biru yang lebih gelap saat hover */
}
...
<body>
    ...
    <div class="container mt-5">
        <section id="produk">
            <h2 class="text-center">Jenis Mobil</h2> <!-- Judul bagian produk -->
            <div class="row">
                <?php foreach ($rentals as $indexarray => $nilai) { ?>
                <div class="col-md-4">
